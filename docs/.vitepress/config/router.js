...
export const backend = [
  ...
  },
  {
    text: "操作系统",
    collapsed: true,
    items: [{ text: "GDB", link: "/后端/操作系统/GDB" }],
  },
  {
    text: "数据库",
    collapsed: true,
  ...
  },
  {
    text: "设计模式",
    collapsed: true,
    items: [{ text: "SOLID原则", link: "/后端/设计模式/SOLID原则" }],
  },
  {
    text: "Spring Boot",
    collapsed: true,
        ...
        items: [
          {
            ...
            link: "/后端/Spring Boot/CommandLineRunner",
          },
          {
    ...
    items: [
      {
        ...
        items: [
          {
            text: "第1章 Netty 异步和事件驱动",
            link: "/后端/Netty/1、Netty异步和事件驱动.md",
          },
          {
            text: "第2章 你的第一个Netty应用程序",
            link: "/后端/Netty/2、你的第一个Netty应用程序.md",
          },
          {
            text: "第3章 Netty的组件和设计",
            link: "/后端/Netty/3、Netty的组件和设计.md",
          },
          ...
          {
            text: "第7章 EventLoop和线程模型",
            link: "后端/Netty/7、EventLoop和线程模型",
          },
      ...
      },
      {
        ...
        collapsed: true,
        items: [
          { text: "第12章 WebSocket", link: "/后端/Netty/12、WebSocket.md" },
          {
            text: "第13章 使用UDP广播事件",
            link: "/后端/Netty/13、使用UDP广播事件.md",
          },
        ],
      },
      {
        ...
        collapsed: true,
        items: [
          { text: "第14章 案例研究一", link: "/后端/Netty/14、案例研究一.md" },
          { text: "第15章 案例研究二", link: "/后端/Netty/15、案例研究二.md" },
        ],
      },
    ],
  },
...
export const tools = [
  {
    text: "sketch",
    collapsed: true,
    items: [{ text: "基本操作", link: "/工具/sketch/基本操作" }],
  },
  {
    text: "ManimGL",
    collapsed: true,
    items: [{ text: "manim", link: "/工具/manim/index" }],
  },
  {
    text: "Vim",
    collapsed: true,

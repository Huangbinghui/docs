...
![图 6-1  Channel 的状态模型](/Netty实战_page_95_1.png)
...
![图 6-2  ChannelHandlerAdapter 类的层次结构](/Netty实战_page_98_1.png)
...
![图 6-3  ChannelPipeline 和它的 ChannelHandler](/Netty实战_page_101_1.png)
...
![图 6-4  Channel、ChannelPipeline、ChannelHandler 以及 ChannelHandlerContext 之间的关系](/Netty实战_page_106_1.png)
...
![图 6-5  通过 Channel 或者 ChannelPipeline 进行的事件传播](/Netty实战_page_107_1.png)
...
![图 6-6  通过 ChannelHandlerContext 触发的操作的事件流](/Netty实战_page_108_2.png)
